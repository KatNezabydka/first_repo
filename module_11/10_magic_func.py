"""
You need to implement all comparison methods for the Vector class. For simplicity, we will compare instances of the Vector class only by their length, using the len method, without taking into account the direction of the vectors.
